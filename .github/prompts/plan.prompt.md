...
3. Identify Cardano-specific requirements:
   ...
   - Blockchain interactions (Lucid Evolution or Mesh)?
...
Keep the plan concise (five to ten steps). If the work is trivial, state that a
full plan is unnecessary and suggest moving straight to implementation.

**Cardano-specific considerations**:

- For smart contracts: Plan testnet deployment before mainnet.
- For CIP standards: Use `semantic_search` to review specifications.
- For security-critical code: Include an audit step in the plan.
