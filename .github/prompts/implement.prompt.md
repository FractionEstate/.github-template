...
1. Re-read the plan; call out any gaps before starting.
2. Modify code in small, reviewable commits; explain complex changes with brief comments.
3. Prefer adapting existing patterns over inventing new abstractions.
4. For Cardano-specific code:
   - **Smart contracts**: Follow `.github/instructions/plutus-guidelines.instructions.md` or `.github/instructions/aiken-guidelines.instructions.md`
   - **Wallet integration**: Follow `.github/instructions/wallet-integration.instructions.md`
   - **Transactions**: Use Lucid Evolution from Anastasia-Labs (`@lucid-evolution/lucid`)
   - **CIP standards**: Use `semantic_search` to look up specifications
...
7. For smart contracts, verify security:
   ...
   - 100% test coverage
   - Security audit checklist completed (see `.github/instructions/smart-contract-security.instructions.md`)
...
- MUST be reviewed by 2+ developers
